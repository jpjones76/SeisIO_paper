...
#-------------------------------------------------------------------#
fi_obspy = "TA.121A.--.HHZ_true_Obspy.mseed"
fi_seisio = "TA.121A.--.HHZ_true_SeisIO.csv"
...
ax1.set_xlim([datetime.datetime(2018, 3, 1, 12, 0), datetime.datetime(2018, 3, 1, 12, 5)])
ax1.set_ylim([-1, 1])
...
ax1.set_title('TA.121A.HHZ: 2018-03-01', fontsize=14, color="black", fontweight="bold", family="serif")

...
#--- parameters----------------#
starttime   = "2014-03-01T00:00:00.000"
duration = 86400*3 # [s]
...
if IsRemoveresp
    remove_response!(S,stationxmlfilename,0.05,8.,np=2)
end
...
# t = collect(starttime:Millisecond(1 / S[1].fs * 1000):starttime+Day(1))[1:end-1]
# #plotly()
# span = 10000
# plot(t[1:span:end],newarr[1:span:end-1],label="obspy")
# plot!(t[1:span:end],S[1].x[1:span:end-1],label="SeisIO")

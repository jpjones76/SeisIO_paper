...
# paths and filenames
rootpath = os.getcwd()
DATADIR  = os.path.join(rootpath,'../output/%s/obspy/RAW_DATA_rmresp_ref'%args[1])         # where to store the downloaded data
...
if rank == 0:
    ...
    fo=open(DATADIR+"/../downloadtime_BP_removeresp_ref_np%s.txt"%args[1], "w")

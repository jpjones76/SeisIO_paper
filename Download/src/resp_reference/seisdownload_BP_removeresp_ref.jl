...
InputDictionary_download = Dict([
        ...
        "starttime"   => DateTime(2006,3,1,0,0,0),
        "endtime"     => DateTime(2006,3,3,0,0,0),
        ...
        "fopath"           => joinpath(Outputdir, "Rawdata_removeresp_ref.jld2"), # this is automatically determined by arguments
...
fo = open(Outputdir*"/downloadtime_BP_removeresp_ref_np$np.txt", "w");

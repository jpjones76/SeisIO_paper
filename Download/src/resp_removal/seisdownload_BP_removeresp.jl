...
InputDictionary_download = Dict([
        ...
        "fopath"           => joinpath(Outputdir, "Rawdata_removeresp.jld2"), # this is automatically determined by arguments
...
fo = open(Outputdir*"/downloadtime_BP_removeresp_np$np.txt", "w");
